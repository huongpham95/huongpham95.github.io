...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.tick = function (event) {
            ...
            if (this.dragging) {
                ...
                ctx.fillRect(event.touches[0].clientX, event.touches[0].clientY, 1, 1);
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_1" /* ViewChild */])("myCanvas"),
        __metadata("design:type", Object)
    ], AppComponent.prototype, "myCanvas", void 0);
    AppComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: "app-root",
            template: "\n    <div>\n      <canvas #myCanvas width=\"400\" height=\"400\" style=\"background:while;\" \n      (touchmove) =\"tick($event)\" (touchstart)=\"engage($event)\" (touchend)=\"disengage()\"></canvas>\n      \n    </div>\n    "
        })
    ], AppComponent);
    return AppComponent;
}());
